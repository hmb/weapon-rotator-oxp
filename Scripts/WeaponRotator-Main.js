...
this.$storablePrefix = "weaponRotator";
...
{
  var missVar = missionVariables[this.$storablePrefix + "_" + varName];
  this["$" + varName] = missVar==null? defaultValue : missVar;
}

this._setMissionVariable = function(varName)
{
  missionVariables[this.$storablePrefix + "_" + varName] = this["$" + varName];
}
